...
class Ambulans(AmbulansParent):
  def __init__(self, id = 0):
      ...
      print(self.harita.mudahale_bolgeleri, "TEST")
      print(self.harita.mudahale_bolgeleri[0])
      ...
      self.eskihedefler = [(hedef.enlem, hedef.boylam) for hedef in self.harita.mudahale_bolgeleri]
      #*******|| Hedef Bölge Hesabı ||********
  ...
  def HedefSirasiniBelirle(self):
      sira = [None] * len(self.harita.mudahale_bolgeleri)
      self.siralimi = False

      for hedef in self.harita.mudahale_bolgeleri:
          hedef.amac = 1
          #if hedef.sira == -1:
            #  sira.append(hedef)
          #elif hedef.sira == 0:
