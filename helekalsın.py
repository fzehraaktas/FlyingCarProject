...
class Cezeri(CezeriParent):   
    ...
    def run(self):
        ...
        if self.irtifa < 105 and self.irtifa_araliginda == False:
        ...
        elif self.irtifa > 110 and self.irtifa_araliginda == False and bolge_2.yukselti + 20 < self.irtifa and self.semihvural == False:
        ...
        elif bolge_2.yukselti + 20 > self.irtifa and self.irtifa_araliginda == False: 
            self.yukari_git(HIZLI)
            ...
            self.dur()
            print("ilkinçetinkayasabancıdepremzede")
